...
describe('ConverterComponent', () => {
    ...
    const createComponent = createComponentFactory({
        ...
        declarations: [MockComponent(MdbIconComponent), MockComponent(ModalDirective)],
        providers: [
    ...
    it('links to our website', () => {
        expect(spectator.query('.container a')).toContainProperty(
            'href',
            'https://noticeeverything.com',
        );
    });
